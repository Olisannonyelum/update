...
#######################################################################
    def ok(self,instance):
        ...
        #self.root.ids.bible.text=f'{self.book_pressed}'+f'{self.dialogBox.ids.TextField_1.text}'+\
   #                                 self.dialogBox.ids.TextField_2.text,\
   #                                     f'{str(self.dialogBox.ids.TextField_3.text)}'
        #self.book_pressed=instance.text
    ...
    def get_verse(self,book, chapter, verse):## this is where am getting the problem
